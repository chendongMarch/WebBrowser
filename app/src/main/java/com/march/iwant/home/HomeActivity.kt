...
import com.march.iwant.pz.PzActivity
import com.march.iwant.xxxiao.XiaoAlbumActivity
 ...
 *  @author chendong
 */
class HomeActivity : IWantActivity() {
    ...
    private fun dispatchItemClick(data: HomeDataModel?) {
        ...
        when (data?.id) {
            ...
            2 -> {
                intent = Intent(HomeActivity@ this, XiaoAlbumActivity::class.java)
            }
